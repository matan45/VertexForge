...
void writeVertex(uint idx, vec3 rootPos, vec3 localOff, float h, float w,
                 float cr, float sr, float wp, float a, vec3 n, uint vt) {
...
void main() {
    ...
    if (vt == 1u) {
        ...
        writeVertex(0, rootPos, vec3(-halfW, 0.0, 0.0), 0.0, bW, cr, sr, wp, alpha, bn, vt);
        writeVertex(1, rootPos, vec3( halfW, 0.0, 0.0), 0.0, bW, cr, sr, wp, alpha, bn, vt);
        writeVertex(2, rootPos, vec3(-midW, bH*0.33, 0.0), 0.33, bW, cr, sr, wp, alpha, bn, vt);
        writeVertex(3, rootPos, vec3( midW, bH*0.33, 0.0), 0.33, bW, cr, sr, wp, alpha, bn, vt);
        writeVertex(4, rootPos, vec3(-midW*0.5, bH*0.66, 0.0), 0.66, bW, cr, sr, wp, alpha, bn, vt);
        writeVertex(5, rootPos, vec3( midW*0.5, bH*0.66, 0.0), 0.66, bW, cr, sr, wp, alpha, bn, vt);
        writeVertex(6, rootPos, vec3(0.0, bH, 0.0), 1.0, bW, cr, sr, wp, alpha, bn, vt);
