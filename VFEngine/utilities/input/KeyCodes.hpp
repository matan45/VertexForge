...
namespace input {
    ...
    namespace Key {
        ...
        constexpr int Num0 = 48; constexpr int Num1 = 49; constexpr int Num2 = 50;
        constexpr int Num3 = 51; constexpr int Num4 = 52; constexpr int Num5 = 53;
        constexpr int Num6 = 54; constexpr int Num7 = 55; constexpr int Num8 = 56;
        constexpr int Num9 = 57;
        constexpr int Semicolon = 59;
        constexpr int Equal = 61;
        constexpr int A = 65; constexpr int B = 66; constexpr int C = 67;
        constexpr int D = 68; constexpr int E = 69; constexpr int F = 70;
        constexpr int G = 71; constexpr int H = 72; constexpr int I = 73;
        constexpr int J = 74; constexpr int K = 75; constexpr int L = 76;
        constexpr int M = 77; constexpr int N = 78; constexpr int O = 79;
        constexpr int P = 80; constexpr int Q = 81; constexpr int R = 82;
        constexpr int S = 83; constexpr int T = 84; constexpr int U = 85;
        constexpr int V = 86; constexpr int W = 87; constexpr int X = 88;
        constexpr int Y = 89; constexpr int Z = 90;
        ...
        constexpr int F1 = 290; constexpr int F2 = 291; constexpr int F3 = 292;
        constexpr int F4 = 293; constexpr int F5 = 294; constexpr int F6 = 295;
        constexpr int F7 = 296; constexpr int F8 = 297; constexpr int F9 = 298;
        constexpr int F10 = 299; constexpr int F11 = 300; constexpr int F12 = 301;
    ...
    // Mouse button codes (matching GLFW values)
    namespace Mouse {
