...
namespace core::api
{
    namespace
    {
        void registerDamageCommands(services::ScriptInterpreter* interpreter,
    ...
    void DestructionAPI::registerAPI(services::ScriptInterpreter* interpreter)
    {
        ...
        registerDamageCommands(interpreter, dispatcher);
        registerHealthQueries(interpreter, dispatcher);
    }
}
