...
namespace core
{
    ...
    public:
        ...
        static constexpr const char* kSocketAttachmentListener = "ISocketAttachmentListener";
        static constexpr std::array<const char*, 1> kRequiredInterfaces = { kSocketAttachmentListener };
    ...
    private:
        void dispatchSocketEvent(::services::EntityHandle childEntity,
