...
namespace core
{
    ...
    public:
        ...
        static constexpr const char* kWeatherEventListener = "IWeatherEventListener";
        static constexpr std::array<const char*, 1> kRequiredInterfaces = { kWeatherEventListener };
