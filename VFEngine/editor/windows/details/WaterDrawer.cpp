...
namespace windows::details {
    ...
    bool WaterDrawer::draw(services::EntityHandle handle)
    {
        ...
        if (isOpen)
        {
            ...
            drawSaveLoadSection(handle, data);
            drawGridExpansionSection(handle);
            drawStreamingSection(handle);
    ...
    void WaterDrawer::drawSaveLoadSection(services::EntityHandle handle, const services::WaterData& data)
    {
        ImGui::Separator();
        ImGui::Text("Save");
    ...
    void WaterDrawer::drawGridExpansionSection(services::EntityHandle handle)
    {
        auto& dispatcher = events::EventDispatcher::instance();
    ...
    void WaterDrawer::drawStreamingSection(services::EntityHandle handle)
    {
        auto& dispatcher = events::EventDispatcher::instance();
