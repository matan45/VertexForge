...
namespace services
{
    ...
    bool WaterService::rebuildFromFile(EntityHandle waterHandle)
    {
        auto& registry = scene::EntityRegistry::getRegistry();
        entt::entity entity = internal::fromHandle(waterHandle);
    ...
    void WaterService::rebuildFromComponentData(EntityHandle waterHandle)
    {
        auto& registry = scene::EntityRegistry::getRegistry();
        entt::entity entity = internal::fromHandle(waterHandle);
        auto& waterComp = registry.get<components::WaterComponent>(entity);
    ...
    void WaterService::rebuildWaterFromComponents()
    {
        ...
        for (auto entity : waterView)
        {
            ...
            if (!rebuildFromFile(waterHandle))
                rebuildFromComponentData(waterHandle);
        }
