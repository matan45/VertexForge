...
namespace services
{
    ...
    private:
        ...
        // VK-1606: "is there water at all", resolved ONCE per frame in applyControllerMovement.
        // GetOceanHeightAtQuery returns 0 for "no water", which is indistinguishable from a real
        ...
        //
        // VK-1607: the check is now "any water" (ocean OR a water body), not "an ocean entity" - a
        // lake with no ocean in the scene is still swimmable.
        bool waterPresentThisFrame = false;
